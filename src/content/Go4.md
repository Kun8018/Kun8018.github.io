...
Gorp 是一个简单的 Go 语言 ORM 库，可以方便地操作[关系型数据库](https://so.csdn.net/so/search?q=关系型数据库&spm=1001.2101.3001.7020)，如 MySQL、PostgreSQL 和 SQLite 等。
...
https://github.com/rubenv/sql-migrate/projects?query=is%3Aopen
