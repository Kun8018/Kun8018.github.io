...
**全球最大的预印本（Preprint）存储库。**

- **它的本质**：它是一个**文档仓库**。由康奈尔大学运营。

- **核心概念——预印本 (Preprint)**：

  - 当你的论文写好了，但还没有被期刊或会议正式录用（这个过程可能需要好几个月），你可以先把文章上传到 arXiv。
  - 一旦上传，这篇文章就对全世界**免费公开**了。

- **为什么大家都要传 arXiv？**

  1. **占坑（Claim Priority）**：学术界讲究“谁先做出来”。因为会议评审很慢，传到 arXiv 上会有时间戳，证明“这个想法是我先提出来的”。
  2. **快速传播**：不需要等半年后的会议召开，同行立刻就能看到你的成果，引用你的文章。
  3. **免费**：不需要像某些期刊那样付费下载。

- **特点**：

  - **没有同行评审 (Peer Review)**：只要格式正确、内容看起来像学术文章，基本都能发出来。所以 arXiv 上的文章**质量参差不齐**，有诺贝尔奖级的神作，也有各种注水文。

  - **主要领域**：物理、数学、计算机（AI）、生物等。

    

大部分大佬写完论文，会**先挂到 arXiv** 上占坑，然后**同时投稿到 OpenReview**（如果是投 ICLR 等会议）等待评审

## openreview

- **它的本质**：它是一个**评审管理平台**。
- **核心概念——公开评审 (Open Peer Review)**：
  - 传统的投稿系统（如 CMT, EasyChair），审稿人骂你只有你能看见（盲审）。
  - OpenReview 提倡**全透明**。你投的论文、审稿人给的评分和评语、你反驳审稿人的回复（Rebuttal），**所有人（包括吃瓜群众）都能看到**。
- **谁在使用？**
  - 主要是顶级的 AI 会议，最著名的是 **ICLR**（深度学习顶级会议），以及 NeurIPS、ICML 等也部分使用。
- **特点**：
  - **双盲但公开**：评审期间，大家看不到作者名字（防走后门），但能看到文章内容和互喷过程。
  - **社区参与**：除了官方审稿人，注册用户有时候也可以去评论某篇论文，给审稿人提供线索（比如指出这篇论文抄袭，或者公式推导错误）

## 学术会议

CV界的会议一般分三级：

[oral](https://zhida.zhihu.com/search?content_id=825710&content_type=Answer&match_order=1&q=oral&zhida_source=entity)，需要作者准备PPT上台进行presentation；

[poster](https://zhida.zhihu.com/search?content_id=825710&content_type=Answer&match_order=1&q=poster&zhida_source=entity)，作者贴一张海报，如果有人感兴趣就会到该作者的墙报前面讨论；

[workshop](https://zhida.zhihu.com/search?content_id=825710&content_type=Answer&match_order=1&q=workshop&zhida_source=entity)，一般都是某些大牛觉得该领域有哪些方面是研究热点，就向会议chair申请开一个独立的研讨会，值得注意的是workshop是独立审稿的

其他

full paper: 全文收录；

short paper：如果审稿人认为作者的文章没那么优秀，但是又没有很强的理由拒绝，就会询问作者是否愿意降格为该类文章（参考会议：[CIKM](https://zhida.zhihu.com/search?content_id=825710&content_type=Answer&match_order=1&q=CIKM&zhida_source=entity)）。啰嗦一句，会议一般不会专门开设一个track让作者投short paper，这与下面要说的poster有所不同。

poster：通常只有2页，也有可能是上述情况（不同会议的叫法不同），也有可能是作者只希望把自己的idea讲出来，于是特意投了一个poster
...
使用这些信息，您可以选择**不再阅读**（也不打印出来，从而节约树木）。这可能是因为您对这篇论文不感兴趣，或者您对该领域了解不足，无法理解这篇论文，或者作者做出了无效的假设。对于不在您研究领域的论文，第一遍阅读就足够了，但可能将来会变得相关。
...
- **优势：**强大的数值计算能力和矩阵操作，广泛的工程工具箱，适合信号处理、图像分析、控制系统等工程仿真领域。
- **特点：**适合快速开发和仿真测试。﻿
...
求之机器人：https://air.tsinghua.edu.cn/info/1147/2175.htm

傅立叶机器人：https://www.fftai.cn/contact
